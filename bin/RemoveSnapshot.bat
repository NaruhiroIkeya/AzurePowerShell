...
IF NOT EXIST %~dpn0.ps1 (
  SET __TIME__=%TIME:~0,8%
  ECHO [%DATE% %__TIME__: =0%] RemoveSnapshot実行スクリプトが存在しません。
  EXIT /B 1
)
...
::      スクリプト本体実行      ::
::::::::::::::::::::::::::::::::::
CALL :__ECHO__ RemoveSnapshot実行処理（%~n0.ps1）を開始します。
...
::::::::::::::::::::::::::::::::::::::::::
IF ERRORLEVEL 1 (
  CALL :__ECHO__ RemoveSnapshot実行処理中にエラーが発生しました。
  EXIT /B 100
)
CALL :__ECHO__ RemoveSnapshot実行処理が完了しました。
